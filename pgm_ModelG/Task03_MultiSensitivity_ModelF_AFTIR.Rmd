---
title: "Task03_Sensitivity_Analysis_pt2"
author: "Miandra Ellis, Sameed Ahmed"
...
plot(g)
ggsave("../results/Task03_AFTIR.Kssd.pdf",width = width,height=height)
g = g %+% plots.T.Kssd
g = g + labs(y="Trough Free Tissue target to\ninitial target Ratio (TFTIR)",
             caption = "Kssd")
# plot(g)
# ggsave("../results/Task03_TFTIR.Kssd.pdf",width = width,height=height)
# 
# g = g %+% plots.A.Kss
# g = g + labs(y="Average Free Tissue target to\nInitial target Ratio (AFTIR)",
#              caption = "Kss")
# plot(g)
# ggsave("../results/Task03_AFTIR.Kss.pdf",width = width,height=height)
# g = g %+% plots.T.Kss
# g = g + labs(y="Trough Free Tissue target to\ninitial target Ratio (TFTIR)",
#              caption = "Kss")
# plot(g)
# ggsave("../results/Task03_TFTIR.Kss.pdf",width = width,height=height)
# 
# g = g %+% plots.A.Kd
# g = g + labs(y="Average Free Tissue target to\nInitial target Ratio (AFTIR)",
#              caption = "Kd")
# plot(g)
# ggsave("../results/Task03_AFTIR.Kd.pdf",width = width,height=height)
# g = g %+% plots.T.Kd
# g = g + labs(y="Trough Free Tissue target to\ninitial target Ratio (TFTIR)",
#              caption = "Kd")
# plot(g)
# ggsave("../results/Task03_TFTIR.Kd.pdf",width = width,height=height)
```
