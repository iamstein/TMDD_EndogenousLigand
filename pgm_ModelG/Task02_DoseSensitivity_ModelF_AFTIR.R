...
source("ams_initialize_script_v3.R")
...
width = 7
height = 2.7
ggsave("../results/Task02_Dose_AFTIR.pdf",width = width,height=height)

g = g %+% plots.T
g = g + labs(y="Trough Free Tissue target to\ninitial target Ratio (TFTIR)")
print(g)
ggsave("../results/Task02_Dose_TFTIR.pdf",width =  width,height=height)
