...
# Individual simulation examlpe with rxode and multiple doses
```{r, warning=FALSE}
...
#Individual Simulation, single dose, overlay data - Model G (DTL)

I'm choosing somewhat unealistic elimination rates for IL-6 (keL, keDL) here, just to get a good match.  So for instance, I'm using keL = 1/day instead of 40/day.  We would need to think about this system some more.
